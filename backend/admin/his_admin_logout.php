                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="his_admin_logout.php">
                                        <span><img src="assets/images/logo-dark.png" alt="" height="150"></span>
                                    </a>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Back to <a href="index.html" class="text-white ml-1"><b style="color: black;">Log In</b></a> OR <a href="../../index.html" class="text-white ml-1"><b style="color: black">HomePage</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
